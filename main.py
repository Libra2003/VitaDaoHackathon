...
def secondPage():
    ...
    label1 = customtkinter.CTkLabel(master=frame, text="weight")
    ...
    combobox2.set("Current Smoker")
    combobox2.grid(row=3, column=1, padx=12, pady=10)
    smoking=combobox2.get()
